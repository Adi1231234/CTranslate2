...
between its 2nd and 4th LayerNorm (or fused residual norm), with grid, duration and the distinguishing part of the demangled name.
...
norms = {"LayerNormForwardCUDAKernel", "residual_norm_kernel"}      # the latter: residual add + next norm
ln = [i for i, k in enumerate(ks) if S[k[2]] in norms]
