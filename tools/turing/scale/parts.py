...
data = common.cached_units(CACHE, LISTING)
...
transcribe_unit(model, data[0], MODE, common.Recorder())   # warm-up
rec = common.Recorder()
...
print(json.dumps({"mode": MODE, "units": len(data), "audio_h": round(audio_s / 3600, 2), "weights_mb": base,
